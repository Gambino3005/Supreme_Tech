...
$usuario_id = $_SESSION['user_id'] ?? null; // Asegúrate de que el usuario esté autenticado
...
<nav class="navbar navbar-expand-lg navbar-dark sticky-top">
    ...
    <div class="container">
        <div class="card p-4">
        <img src="../assets/img/Logo.png" alt="Logo" class="Logo img img-fluid d-block mx-auto">       <hr>
            <h2 class="text-center mb-4">Pedido Confirmado ✅</h2>
            <p>Gracias por tu compra, <strong><?php echo htmlspecialchars($pedido['nombre_usuario']); ?></strong>. A continuación, te mostramos los detalles de tu pedido.</p>
